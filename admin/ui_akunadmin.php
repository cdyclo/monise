                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">Kelola User Admin</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content bg-lightblue">
                                <div class="modal-header">
                                    <h4 class="modal-title">Kelola User Admin</h4>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input rangelength="5,20" type="text" name="Username" class="form-control number" required placeholder="Masukkan Username">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" style="text-align: left;">Password</label>
                                        <div class="col-sm-9">
                                            <input rangelength="5,20" type="text" name="Password" class="form-control" required placeholder="Masukkan Password">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" style="text-align: left;">Nama Admin</label>
                                        <div class="col-sm-9">
                                            <input type="text" number name="Nama" class="form-control" required placeholder="Masukkan Nama Admin">
                                        </div>
                                    </div>
                            ...
                            <div class="modal-content bg-light">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" style="text-align: left;">Username</label>
                                        <div class="col-sm-9">
                                            <input rangelength="5,20" type="text" name="username" id="username" class="form-control number" required placeholder="Masukkan Username">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" style="text-align: left;">Password</label>
